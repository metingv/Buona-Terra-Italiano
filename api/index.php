...
switch($method) {
    ...
    case "POST":
        ...
        $sql = "INSERT INTO news(id, name, email, mobile, created_at) VALUES(null, :name, :email, :mobile, :created_at)";
        $stmt = $conn->prepare($sql);
    ...
    case "PUT":
        // edit user
        $user = json_decode( file_get_contents('php://input') );
        $sql = "UPDATE news SET name= :name, email =:email, mobile =:mobile, updated_at =:updated_at WHERE id = :id";
        $stmt = $conn->prepare($sql);
